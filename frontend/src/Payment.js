...
function Payment() {
  ...
  const handleClick=(event)=>{
    ...
    const prenda_id=parseInt(productId)
    comprar({prenda_id, talla})
    navigate("/")
  }
  const handleNum = (e) => {
            ...
            <form id="form">
                <div id="card">
                    <div className="header">
                        ...
                        <div>
                        <img className="logo_payments" src={cardTypeUrl} alt="Card logo"/>
                        </div>
                    </div>
                    <div className="body">
                ...
                <button onClick={handleClick}>{`Submit ${cardType} payment`}</button>
            </form>
        </div>
        </div>
    </div>
